                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="text-center my-4">
                            <Link onClick={() => { clear() }} className="btn btn-dark btn-outline-light fw-bold" title="Vaciar Carrito">Vaciar Carrito</Link>
                        </div>
                        ...
                        <div className="text-center my-4">
                            <Link to={"/checkout"} className="btn btn-dark btn-outline-light fw-bold" title="finalizar compra">Finalizar Compra</Link>
                        </div>
                    </div>
                </div>
            </div>
